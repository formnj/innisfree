<template>
  <div class="docTopBanner txtBanner">
    <a :href="mainTopBannerData.url" class="txt" target="_blank">{{
      mainTopBannerData.bannerText
    }}</a>
    ...
    <div class="inner">
      ...
      <div class="quick_wrap">
        ...
        <ul class="icon_menu">
          ...
          <li>
            <a :href="path + 'IN_PC_CAR_01_01'" class="cart"
              >장바구니
              <em>5</em>
            </a>
          </li>
      ...
      <div class="inner">
        ...
        <nav class="navGnb">
          <ul>
            ...
            <li>
              <a :href="path + 'IN_PC_HOM_01_04'" class="point"
                ><em>특가</em></a
              >
            </li>
            <li class="active">
...
const roll_fn = () => {
  ...
  roll_idx.value++
  roll_ele.value.style.cssText = `transform: translateY(-${
    roll_height * roll_idx.value
  }px); transition: all 0.35s ease-in`
...
onMounted(() => {
  ...
  /* header search layer */
  document
    .querySelector('.search_wrap > .search input')
  ...
  document
    .querySelector('.search_layer .input input')
    .addEventListener('input', auto_complete)
})
...
const auto_complete = (e) => {
  ...
  auto_list.value = latestSearchWordData.filter(
    (e) => e.word.indexOf(isValid.value) >= 0
  )
  prd_list.value = sample_goods.filter(
    (e) => e.name !== undefined && e.name.indexOf(isValid.value) >= 0
  )
