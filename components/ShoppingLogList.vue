  ...
  >li {
      ...
      a {
        ...
        .thumb {
          ...
          em {
            ...
            background: url('~/assets/images/common/icon_split.png') -189px -279px / 250px auto no-repeat;
    ...
    :deep(a) .thumb {
      ...
      em:first-child:before {
        ...
        width: 24px;
        height: 24px;
        background: #00BC70 url('~/assets/images/common/icon_split.png') -115px -300px / 250px auto no-repeat;
        position: absolute;
        bottom: 20px;
        left: 20px;
        opacity: 0;
