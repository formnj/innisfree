    ...
    <div class="fix_btn">
      ...
      <div class="right_box">
        <Button
          ...
          class="btn_icon btn_icon_barcode"
          txt="멤버십 바코드"
          @click="
            modal.open('modal_beauty_barcode', 'bottom beauty_barcode')
          " />
        <Button
          class="btn_icon btn_icon_history"
          txt="히스토리"
          @click="$router.push('/publish/IN_MO_HOM_01_18')" />
        <Button
          class="btn_icon top_btn"
          txt="상단 이동"
          @click="scroll_top()" />
      </div>
    </div>
              ...
              <li>
                <label for="benefit1" class="inputChk">
                  <input
                    ...
                    id="benefit1"
                    value="N"
                    alt="증정" /><span @click="setFilter($event)">증정</span>
                </label>
              </li>
            </ul>
          </dd>
              ...
              <li>
                <label for="benefit1" class="inputChk">
                  <input
                    ...
                    id="benefit1"
                    value="N"
                    alt="증정" /><span @click="setFilter($event)"
                    >트러블/리페어</span
                  >
                </label>
              </li>
              ...
              <li>
                <label for="benefit1" class="inputChk">
                  <input
                    ...
                    id="benefit1"
                    value="N"
                    alt="증정" /><span @click="setFilter($event)">미백</span>
                </label>
              </li>
              <li>
                <label for="benefit1" class="inputChk">
  ...
  window.addEventListener('scroll', () => {
    ...
    if (preScrollTop < nextScrollTop) {
      if (nextScrollTop >= 350) {
        ...
        actionbar.querySelector('.inner > a').style.cssText =
          'transform: translate(-50%, 32%); transition: all 0.1s linear;'
      }
