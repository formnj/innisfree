<template>
  ...
  <div class="inner">
    <Tabs id="membership_tab" tabType="type_03" :item="[{txt:'Brand Story'},{txt:'Green Tea Heritage'},{txt:'Better For Earth'}]" :tabidx="0" />
    <section>
      <div class="top_visual">
        <div>
          <h2>
          Effective, Nature-Powered <br>Skincare Discovered from the Island
          </h2>
          <p>
...
section {
   > div {
    &.top_visual {
      ...
      background:url(/_nuxt/public/images/sam/p_bg0101.png) no-repeat -381px bottom;
      position:relative;
      > div {
        position:absolute;
        left: 0;
        ...
        &::after {
          ...
          height:56px;
          margin:70px 0;
          background:url('/_nuxt/public/images/sam/bg_arrow.png');
          display: block;
        }
      }
    }
...
.link_box {
  ...
  a {
    ...
    &.list02 {
      background:url('/_nuxt/public/images/sam/p_page02.png') no-repeat center top / 100% auto;
    }
    &.list03 {
      background:url('/_nuxt/public/images/sam/p_page03.png') no-repeat center top / 100% auto;
    }
    span {
      color:#fff;
      font-size:20px;
    ...
    em {
        ...
        &::after {
          ...
          height:16px;
          margin-left:5px;
          background:url('~/assets/images/common/icon_split.png') no-repeat -139px -302px / 250px auto;
          display:inline-block;
        }
      }
  }
