  ...
  <section class="member_grade">
    <div class="inner">
      ...
      <div class="detail_wrap">
        <button type="button" @click="toggle_btn">
          등급 기준 자세히 알아보기
        </button>
        <div>
          <ul class="level">
            ...
            <li>
              <p>VIP</p>
              <span
                >직전 6개월 결제금액<br /><em>10만원 이상 20만원 미만</em></span
              >
            </li>
            <li>
              <p>그린티클럽</p>
          ...
          <ul class="bul_list">
            ...
            <li>
              할인한도 : 회원 할인 시 정상가 기준 20만원까지 구매 가능<br /><span
                >&#40;할인품목&비할인품목 적용제외&#41;</span
              >
            </li>
...
const img_sample = [
  {
    img: '/_nuxt/public/images/sam/kit_2023_2.png',
    date: '2023 하반기',
    text: '마리떼 새해웰컴키트'
  },
  {
  ...
  > div {
    ...
    .level {
      ...
      li {
        ...
        &:nth-child(1) {
          p:before {
            background: url('~/assets/images/common/icon_welcome.png') no-repeat
              0 0 / cover;
          }
        }
        &:nth-child(2) {
          p:before {
            background: url('~/assets/images/common/icon_vip.png') no-repeat 0 0 /
              cover;
          }
        }
        &:nth-child(3) {
          ...
          border-right: 0;
          p:before {
            background: url('~/assets/images/common/icon_green.png') no-repeat 0
              0 / cover;
          }
        }
      }
