  ...
  <div id="alert1" class="modal_wrap">
    <div class="modal_container">
      <div class="modal_content">
        ...
        <h2>알림</h2>
        <p class="txt">추가구성품 할인은 본품 1개 구매당 1개 구매 가능합니다.</p>
      </div>
  ...
  <div id="alert2" class="modal_wrap">
    <div class="modal_container">
      <div class="modal_content">
        <button class="btn_close" @click="modal.close(this);">닫기</button>
        <h2>알림</h2>
        <p class="txt">해당제품은 최종결제금액 00,000원 이상 결제시 0,000원으로 구매 가능합니다.<br>
          최종 결제금액 미충족시 할인 적용되지 않습니다.</p>
      </div>
      <div class="modal_footer">
        <Button class="btn_big confirm" txt="확인" />
      </div>
  ...
  <div id="alert6" class="modal_wrap">
    <div class="modal_container">
      <div class="modal_content">
        <button class="btn_close" @click="modal.close(this);">닫기</button>
        <h2>알림</h2>
        <p class="txt">로그인이 필요한 기능입니다.<br>로그인 하시겠습니까?</p>
      </div>
      <div class="modal_footer">
  ...
  <div id="modal_member_benefit" class="modal_wrap">
    <div class="modal_container">
      <div class="modal_content">
        <button class="btn_close" @click="modal.close(this);">닫기</button>
        <h2>회원 구매 혜택</h2>
        <p class="txt">로그인 후 구매 가능합니다.<br><br>
          뷰티포인트 적립, 쿠폰할인, 이벤트 참여 등 다양한 회원 혜택을 받으세요.</p>
        <div class="gray_box">
          <p>지금 신규가입하면?<br>최대 <em>70,000원</em><br>쿠폰팩 즉시지급<br><a href="#none" class="btn_link_arrw">자세히보기</a></p>
          <span class="img_wrap">
            <img src="~/assets/mo_images/common/img_mem_coupon.png" alt="70,000원">
            <span class="flag">쿠폰팩</span>
          </span>
        </div>
      </div>
      <div class="modal_footer">
        <Button class="btn_big" txt="취소" @click="modal.close(this);" />
        <Button class="btn_big confirm" txt="로그인" />
      </div>
    </div>
    <div class="overlay" @click="modal.close(this);"></div>
  </div>
