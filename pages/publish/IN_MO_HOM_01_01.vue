<template>
  <div class="main">
    <!-- visual -->
    <div class="visual" :style="'top:' + stickyTop + 'px'">
      ...
      <swiper
        ...
        <div class="custom_pagination">
          ...
          <Button
            class="swiper_controler"
            @click="modal.open('visual_modal', 'fullMo')" />
        </div>
        <!-- //customer pagination -->
      </swiper>
    </div>
    ...
    <div class="main_cont_wrap">
      <!-- add 24.06.13 : visual sticky로 추가 -->
      <!-- quick menu -->
      <section class="category">
        <div class="swiper_wrap">
          <swiper class="module_02" v-bind="swieprOpt.category">
            <swiper-slide
              v-for="item in categoryForSearchLayerData"
              :key="item">
              <a href="#none">
                <span class="thumb" :class="item.type"
                  ><!-- 관리자 강조 등록 시 point 클래스 추가 -->
      ...
      <div class="text_banner">
        <div class="swiper_wrap">
          <swiper
            ...
            <swiper-slide>
              <a href="#none" style="background: #b7e8cb"
                >네이버페이 10,000원 혜택</a
              >
            </swiper-slide>
            <swiper-slide>
              <a href="#none" style="color: #fff; background: purple"
                >네이버페이 10,000원 혜택</a
              >
            </swiper-slide>
      ...
      <section class="recommend">
        ...
        <div class="swiper_wrap">
          <swiper class="module_02" v-bind="swieprOpt.recommend02">
      ...
      <section>
        ...
        <div class="swiper_wrap">
          <swiper v-bind="swieprOpt.recommend04">
            <swiper-slide
              v-for="(item, idx) in sample_goods.slice(0, 5)"
              :key="idx"
              class="goods_slide">
      ...
      <section class="ranking">
        ...
        <swiper v-bind="swieprOpt.ranking">
          <swiper-slide>
            <ul class="list_wrap">
              <li v-for="(item, idx) in sample_goods.slice(0, 5)" :key="idx">
                <span class="badge">{{ idx + 1 }}</span>
                <GoodsItem
                  class="type_column type_cart"
                  :item="item"
                  :link="item.link" />
              </li>
            </ul>
...
onMounted(() => {
  // console.log(document.querySelector('.nav_gnb').offsetHeight);
  stickyTop.value = document.querySelector('.nav_gnb').offsetHeight
...
const onSwiper = (swiper) => {
  ...
  if (total < 10) {
    swiper.wrapperEl.parentNode.querySelector(
      '.custom_pagination .current .idx_01'
    ).textContent = '0' + current
    swiper.wrapperEl.parentNode.querySelector(
      '.custom_pagination strong.total'
    ).textContent = '0' + total
  }
}
...
const onSwiper2 = (swiper) => {
  ...
  swiper.wrapperEl.parentNode
    .querySelector('.custom_pagination button')
