<template>
  <div class="prod_swiper_wrap">
    ...
    <!-- 제품 이미지 -->
    <div class="swiper_notify">
      <em>7명의 고객님</em> 동시에 확인중
      <button type="button" class="btn_close" @click="closeNotify">닫기</button>
      ...
      <dl class="benefit_list txt">
        ...
        <dd>
          <ul>
            <li>
              <a href="#none"
                >24.4.11~24.4.13<span class="title"
                  >~50% 멤버십세일 최대 6,000원 추가할인!</span
                ></a
              >
            </li>
            <li>
              <a href="#none"
                >24.4.11~24.4.13<span class="title"
                  >그린티 씨드 세럼 대용량 [지구의달 에디션] 출시!</span
                ></a
              >
            </li>
          </ul>
    ...
    <div class="tab_contents">
      ...
      <div class="tab_cont" style="display: block">
        ...
        <a href="#none" class="prod_detail_banner">
          <img src="~/public/images/sam/img_prod_detail_banner.png" alt="" />
        </a>
        <!-- //제품 상세 배너 -->
          ...
          <dl class="benefit_list">
            ...
            <dd>
              ...
              <Icons
                ...
                txt="뷰티포인트 안내 자세히 보기"
                @click="
                  modal.open('modal_beauty_point_tip', 'alert tooltip')
                " />
              <div id="modal_beauty_point_tip" class="modal_wrap">
                <!-- 뷰티포인트 적립안내 툴팁 -->
                <div class="modal_container">
                  <button class="btn_close" @click="modal.close(this)">
                    툴팁 닫기
                  </button>
                  <div class="modal_content">
                    <h2>뷰티포인트 안내</h2>
                    <p class="txt">
                      아모레퍼시픽 뷰티포인트 통합회원은 회원 등급과 상관없이
                      (뷰티포인트 적립 대상상품에 한하여) 포인트가
                      적립됩니다.<br /><br />
                      <strong
                        >포인트 적립률은 제품별, 브랜드별로 상이하며,<br />쿠폰/뷰티포인트
                        사용 조건과 금액에 따라 상이할 수 있습니다.</strong
                      >
                    </p>
                  </div>
            ...
            <dt>유의사항</dt>
            <dd>
              3.7~9 / 기간내 n개 / 뷰티포인트 전용, APP 전용 / 할인제외,
              증정제외, 구매금액 제외 /반품교환 불가능
            </dd>
          </dl>
        ...
        <section>
          <div class="sub_title_wrap">
            <div>
              ...
              <button
                type="button"
                @click="modal.open('alert_prod_alert', 'alert tooltip')">
                유의사항
              </button>
            </div>
          ...
          <div class="swiper_wrap">
            <swiper :slides-per-view="'auto'">
              <swiper-slide
                v-for="(item, idx) in sample_goods.slice(0, 10)"
                :key="idx"
                class="item">
                <GoodsItem
                  :item="item"
        ...
        <section>
          <div class="sub_title_wrap">
            <div>
              <h4>이 제품과 같은 라인</h4>
              <a href="#none" class="btn_link_arrw"
                ><strong>브라이트닝 포어</strong> 라인</a
              >
            </div>
          </div>
      ...
      <div class="tab_cont tab_cont_review">
        ...
        <div class="no_review">
          <button
            ...
            @click="
              modal.open(
                'modal_review_point_info',
                'fullMo modal_review_point_info'
              )
            ">
            리뷰 포인트 혜택
          </button>
        ...
        <div class="review_option">
          <div class="sort">
            <button
              type="button"
              class="btn_dropdown"
              @click="modal.open('review_filter', 'bottom')">
              전체 리뷰
            </button>
          ...
          <div class="sort">
            <button
              type="button"
              class="btn_dropdown"
              @click="modal.open('review_sort', 'bottom')">
              추천순
            </button>
            <div id="review_sort" class="modal_wrap">
              ...
              <div class="modal_container">
                ...
                <div class="modal_content">
                  ...
                  <div class="inner">
                    <p class="i_noti">
                      추천순 : 리뷰의 내용을 단위별로 분석해 AI가 부여한 점수
                      산정 기준에 따라 높은 점수 순으로 리뷰를 정렬합니다.
                    </p>
                  </div>
                </div>
              </div>
  ...
  <div id="alert_prod_alert" class="modal_wrap">
    <div class="modal_container">
      <div class="modal_content">
        ...
        <p class="txt">
          <strong>납작아이브로우 / 컨실러 2개이상 구매시 40%</strong
          ><br /><br />동일 제품 및 교차 구매 가능 / 기간 내 최대 10 구매
          가능<br />기간 : 4/14(일) - 5/1(수) 23:59:00까지
        </p>
      </div>
      <div class="modal_footer">
    ...
    <div class="modal_container">
      ...
      <div class="modal_content">
        ...
        <ul class="bul_list dot">
          <li>
            2022년 1월 1일부터 뷰티포인트 운영 정책에 따라 비구매성
            포인트(이벤트 포인트)는 연간 누적 2,000,000P 를 초과하거나 동일한
            적립 사유로 고객님의 일 적립 요청 횟수가 50회를 초과하는 경우,
            뷰티포인트 적립이 불가능합니다.
            <ul class="bul_list dot">
              <li>
                비구매성 포인트 예시: 리뷰 작성, 리뷰 프로필 등록, 이벤트 참여,
                공병수거 적립, 공병 프리퀀시 혜택, 특정 제품 구매 추가 적립
                등으로 인한 적립 뷰티포인트
              </li>
              <li>잔여 한도 내에서는 부분 적립됩니다.</li>
              <li>
                누적 포인트는 사용기한, 적립된 포인트의 사용/소멸 여부 등과
                관계없이 초과적립분에 대해서는 적립 제한됩니다.
              </li>
            </ul>
          </li>
          <li>
            리뷰 작성은 무제한으로 가능하나, 월 최대 6,000P까지 적립이
            제한됩니다.
          </li>
          <li>
            한달리뷰 작성 시 일반 한달리뷰의 경우 50P, 포토 한달리뷰의 경우
            뷰티포인트 100P 적립됩니다.
          </li>
          <li>
            샘플 마켓 신청 제품의 경우 샘플 리뷰를 작성하더라도 뷰티포인트가
            따로 자동 적립 되지 않습니다.
          </li>
          <li>
            리뷰 작성으로 적립된 뷰티포인트는 적립일 기준 90일간 사용할 수
            있으며, 유효기간 경과 후에는 별도 알람없이 소멸됩니다.
            <ul class="bul_list dot">
              <li>
                (소멸 예정 포인트에 대해 회사는 별도의 고지에 대한 의무를
                부담하지 않습니다. 자세한 포인트 소멸 예정일은 뷰티포인트 사이트
                및 어플에서 확인 가능합니다.)
              </li>
            </ul>
          </li>
          <li>
            리뷰 이벤트 진행 제품은 뷰티포인트 적립액이 달라질 수 있습니다.
          </li>
          <li>
            작성하신 리뷰를 삭제하면 적립되었던 리뷰포인트가 회수되며, 리뷰 작성
            가능 기간이 지나지 않은 경우에는 재작성후 포인트 재적립이
            가능합니다. ( 리뷰 삭제 시점에 리뷰 작성 가능 기간이 지난 경우 리뷰
            재작성 및 포인트 재적립이 불가합니다. )
          </li>
          <li>
            작성하신 리뷰를 수정하면 기존 적립된 리뷰포인트가 회수된 후 일반
            리뷰 적립 기준에 맞게 재적립 됩니다.
          </li>
          <li>
            이벤트성으로 적립된 비구매성포인트의 경우, 이벤트 기간 이후 리뷰
            수정 시 동일 수준의 포인트 적립이 불가할 수 있으며, 이미 적립된
...
.prod_swiper_wrap {
  ...
  .swiper_notify {
    ...
    .btn_close {
      ...
      margin-left: 1rem;
      font-size: 0;
      background: url('/assets/mo_images/common/icon_split.png') -10.5rem -7rem /
  ...
  & > .sort {
    ...
    & > button {
      ...
      &:after {
        ...
        height: 1.6rem;
        margin-left: 0.5rem;
        background: url(~/assets/images/common/icon_split.png) -11rem -6rem /
          25rem auto no-repeat;
        display: inline-block;
      }
    }
