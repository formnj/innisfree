<template>
  ...
  <div class="inner">
    <Tabs id="membership_tab" tabType="type_03" :item="[{txt:'멤버십 등급/혜택안내'},{txt:'뷰티포인트 안내'},{txt:'모바일 앱 다운로드'}]" :tabidx="1" />
    <div class="user_wrap">
    ...
    <section class="beauty_point">
      ...
      <div class="beauty_wrap">
        ...
        <div class="sub_title_wrap">
          <h4>
            뷰티포인트 사용안내
            <p>적립된 뷰티포인트는 <em>P=1</em>원가치를 지니며, 사용처별 세부 기준은 아모레몰 > 뷰티포인트 가이드에서 확인하실 수 있습니다.</p>
          </h4>
        </div>
        ...
        <div class="sub_title_wrap">
          <h4>
            뷰티포인트 유효기간 및 소멸안내
            <p>유효기간과 소멸 기준을 확인하여 포인트를 관리하실 수 있습니다.</p>
          </h4>
        </div>
        <div class="desc_wrap">
          <p>유의사항</p>
