  ...
  <div class="inner">
    <div class="title_wrap">
      <div class="renewal">
        8분전 갱신
        <img
          src="/assets/images/common/icon_renewal.png"
          @click="modal.open('modal_renewal', 'layer tooltip')" />
      </div>
    </div>
...
<script setup>
import { sample_goods, sample_event } from '~/test/data/publish/dummyData'
