  ...
  <div class="mypage_wrap">
    <section>
      <div class="info_wrap">
        ...
        <p><a :href="path + 'IN_MO_MYP_01_04'"><em>그린티클럽</em> 멤버시네요! 멤버십 혜택을 확인해보세요.</a></p>
        <ul>
          <li>
            <a href="#none">
              <h4>뷰티포인트</h4>
...
<script setup>
import { mypage_list } from '~/test/data/publish/dummyData.js'
    ...
    .info_wrap {
      ...
      > p {
        ...
        &:after {
          ...
          height: 1.6rem;
          margin-top: -0.2rem;
          background: url('~/assets/mo_images/common/icon_split.png') no-repeat -8rem 0;
        ...
        em {
          ...
          &:before {
            ...
            width: 1.6rem;
            height: 1.6rem;
            background: url('~/assets/images/common/icon_rank_gt.png') no-repeat 0 0;
