  ...
  <section class="beauty_point">
    <div class="inner">
      <div class="header">
        ...
        <p>
          뷰티포인트 회원을 위한 등급별 다양하고<br />특별한 혜택을 만나보세요!
        </p>
      </div>
      ...
      <div class="point_con">
        <div class="table row">
          <table>
            ...
            <tbody>
              ...
              <tr>
                <th>
                  리워드 포인트 Ⅰ<br />VIP선정 후 구매 금액<br />200만원 이상
                </th>
                <td>20,000 P</td>
              </tr>
              <tr>
                <th>
                  리워드 포인트 Ⅱ<br />VIP선정 후 구매금액<br />250만원 이상
                </th>
                <td>20,000 P</td>
              </tr>
            </tbody>
        ...
        <ul class="dot_list mt sm">
          ...
          <li>
            ...
            &#40;예: 17년 3월 첫구매 고객의 21년 VIP 선정 기간: 20년 3월~21년
            2월&#41;<br />
        ...
        <div v-if="guide_tab === 0" class="welcome">
          ...
          <div class="help_wrap">
            <ul>
              ...
              <li>
                * 신청방법<br />아모레몰 > 뷰티파우치 > 뷰티포인트 회원등급 >
                VIP 등급별 혜택 > 웰컴 포인트 적립하기
              </li>
            </ul>
          </div>
        </div>
      ...
      <ul class="dot_list">
        <li>
          회원등급 선정 기준 및 등급별 혜택은 회사 사정에 따라<br />변경될 수
          있습니다.
        </li>
        <li>
          회원등급은 현금 결제금액(할인 후 금액)과 포인트 결제금액의<br />합산금액이
          반영됩니다. (고객별 집계기간 상이)
        </li>
        <li>
          방문판매(방판/리리코스)를 통한 제품 구매 시, 수금금액을 기준으로<br />반영됩니다.
        </li>
        <li>
          ABC 회원 혜택을 받기 위해서는 반드시 아모레퍼시픽 멤버십<br />'뷰티포인트'
          회원(실명인증)이어야 합니다.
        </li>
        <li>
          ...
          <ul>
            ...
            <li>
              - 특정 브랜드 구매 편중 및 적립 과다로 비정상적으로 판단될 경우
            </li>
        ...
        <li>
          VIP 선정기준 및 혜택에 대한 더욱 자세한 안내는 아모레몰 > 마이페이지
          ><br />통합 회원 등급 혜택에서 확인하실 수 있습니다.
        </li>
      </ul>
    </div>
  </section>
