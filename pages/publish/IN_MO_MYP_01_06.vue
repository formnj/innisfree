<template>
  ...
  <section class="beauty_point">
    <div class="inner">
      ...
      <Tabs class="point_tab" :item="[{txt:'PLATINUM\n플래티넘'},{txt:'GOLD\n골드'},{txt:'SILVER\n실버'},{txt:'GREEN\n그린'}]" :tabidx="0" tabType="type_05" />
      <div class="point_con">
        <div class="table row">
          <table>
      ...
      <Tabs class="guide_tab" :item="[{txt:'승급시 웰컴 포인트'},{txt:'리워드 포인트 Ⅰ'},{txt:'리워드 포인트 Ⅱ'}]" :tabidx="0" tabType="type_05" />
      <div class="guide_con">
